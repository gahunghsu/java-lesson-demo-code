...
public class S13_StreamReduce {
    /**
     * 1. 教學目標
     * 展示 Stream API 的標準流水線操作: Filter (過濾) -> Map (轉換) -> Reduce (歸納)。
     *
     * 3. 講師備課指引
     * - 流水線觀念 : 請在白板畫出流水線，數字 1 被過濾掉，數字 2 通過並變身為 4，最後掉進加總的桶子裡。
     * - mapToInt : 說明這裡用 mapToInt 可以直接呼叫 sum()，如果是普通 map 則需要用 reduce。
     */
